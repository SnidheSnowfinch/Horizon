    ...
    <div class="row">
            ...
            <div class="car-card">
                ...
                <div class="car-info">
                    ...
                    <div class="features">
                        <p>Extra Km Fare</p>
                        <div class="inner-div">
                            <div><img src="bootstrap/images/extra-km.png" class="me-2" alt=""><span>Extra Km Fare</span>
                            </div>
                            <div>₹14.3/km <small>after</small> 149 kms</div>
                        </div>
                        <div class="inner-div">
                            <div><img src="bootstrap/images/fuel.png" class="me-2" alt=""><span>Fuel Type</span></div>
                            <div>CNG with refill breaks</div>
                        </div>
                        <div class="inner-div">
                            <div><img src="bootstrap/images/cancellation.png" class="me-2"
        ...
        <div class="booking-card">
            <div class="location-flex">
                <div>
                    <img src="bootstrap/images/locationn.png" alt="">
                </div>
               <div>
               <div>
                    <h3>Pick-up</h3>
        ...
        <div class="col-lg-8 col-md-6 col-sm-12">
            <div class="booking-card">
                ...
                <div class="form-row-contact row">
                    <div class="col-lg-6 col-md-6 col-sm-12"> <label for="">
                            Pickup
                        </label>
...
<p>pune</p>
                ...
                <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12"><p class="fw-semibold">Car Type</p></div>
                <div class="col-lg-6 col-md-6 col-sm-12 p-0">
                <p >tata tiago</p>
                </div></div>
                <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 p-0"><p>mumbai</p>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 p-0"><p>₹ 11500</p></div></div>
    ...
    <div class="row">
        <div class="col-lg-8 col-md-6 col-sm-12">
            <div class="booking-card">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12"> <label>Card Number</label>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 form-row-contact">
                        <label>Country</label>
